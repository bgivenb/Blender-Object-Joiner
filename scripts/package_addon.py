...
DIST = ROOT / "dist"
PACKAGE = "object_joiner"
VERSION = "2.1.0"
SOURCES = {
    f"{PACKAGE}/LICENSE": ROOT / "LICENSE",
    f"{PACKAGE}/__init__.py": ROOT / "objectjoiner.py",
    f"{PACKAGE}/object_joiner_core.py": ROOT / "object_joiner_core.py",
}


def main() -> None:
    DIST.mkdir(exist_ok=True)
    archive = DIST / f"object-joiner-v{VERSION}.zip"
